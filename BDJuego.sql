...
CREATE TABLE `estadisticas` (
  ...
  CONSTRAINT `estadisticas_ibfk_1` FOREIGN KEY (`macaco_id`) REFERENCES `macaco` (`macaco_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,3500,20,NULL,1);
...
-- Dump completed on 2019-11-07 17:46:24
